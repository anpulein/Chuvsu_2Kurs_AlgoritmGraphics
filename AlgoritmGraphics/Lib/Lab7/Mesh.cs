...
namespace Lib.Lab7
{
    ...
    public class Mesh
    {
        ...
        public void load(string filename)
        {
            ...
            determing(_vertices.ToArray());
        }

        public void determing(Vertex[] array)
        {
            vertex = new float[array.Length * 3];
            textCoord = new float[array.Length * 2];
            normal = new float[array.Length * 3];
            ...
            count = array.Select(s => s.coord).Count();
        }
