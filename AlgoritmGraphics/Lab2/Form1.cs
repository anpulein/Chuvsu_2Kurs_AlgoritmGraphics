...
namespace Lab2
{
    public partial class Form1 : Form
    {
        ...
        private void display()
        {
            ...
            Gl.glColor3f(Color.rgb.x, Color.rgb.y, Color.rgb.z);
        ...
        private void simulation(int value)
        {
            ...
            if (reColorTime == 50)
            {
                Color.getRGB();
                reColorTime = 0;
                Console.WriteLine("Обнуляем итерацию выполнения метода simulation!");
            }
            reColorTime++;
            Console.WriteLine($"Итерация выполнения метода simulation:{reColorTime}");
